...
```
Also please find 
[`CellAdapter/sample/src/main/java/org/ervin/sample/BaseCell.java`](https://github.com/ervinmartirosyan/CellAdapter/blob/master/sample/src/main/java/org/ervin/sample/BaseCell.java) 
